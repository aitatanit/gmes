...
void OneEx::update(double * const ex, int ex_x_size, int ex_y_size,
...
void OneEy::update(double * const ey, int ey_x_size, int ey_y_size,
...
void OneEz::update(double * const ez, int ez_x_size, int ez_y_size,
...
void OneHx::update(double * const hx, int hx_x_size, int hx_y_size,
...
void OneHy::update(double * const hy, int hy_x_size, int hy_y_size,
...
void OneHz::update(double * const hz, int hz_x_size, int hz_y_size,
