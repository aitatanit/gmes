...
OneElectric::OneElectric(const int * const idx, int size, double epsilon_r)
...
void
OneElectric::set_epsilon(double epsilon_r)
{
    epsilon = epsilon_r * epsilon0;
}

void
OneEx::update(double * const ex, int ex_x_size, int ex_y_size, int ex_z_size,
...
void
OneEy::update(double * const ey, int ey_x_size, int ey_y_size, int ey_z_size,
...
void
OneEz::update(double * const ez, int ez_x_size, int ez_y_size, int ez_z_size,
		     const double * const hy, int hy_x_size, int hy_y_size, int hy_z_size,
		     const double * const hx, int hx_x_size, int hx_y_size, int hx_z_size,
...
OneMagnetic::OneMagnetic(const int * const idx, int size, double mu_r)
    : PointwiseMaterial(idx, size)
{
    mu = mu_r * mu0;
}
...
void
OneMagnetic::set_mu(double mu_r)
{
    mu = mu_r * mu0;
}

void
OneHx::update(double * const hx, int hx_x_size, int hx_y_size, int hx_z_size,
...
void
OneHy::update(double * const hy, int hy_x_size, int hy_y_size, int hy_z_size,
...
void
OneHz::update(double * const hz, int hz_x_size, int hz_y_size, int hz_z_size,
		     const double * const ey, int ey_x_size, int ey_y_size, int ey_z_size,
		     const double * const ex, int ex_x_size, int ex_y_size, int ex_z_size,
		     double dt, double dx, double dy)
{
