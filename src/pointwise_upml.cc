...
UPMLElectric::UPMLElectric(const int * const idx, int size, double epsilon_r, 
			   double c1_in, double c2_in, double c3_in, 
			   double c4_in, double c5_in, double c6_in)
...
void 
UPMLElectric::set_epsilon(double epsilon_r)
{
    epsilon = epsilon_r * epsilon0;
}

void 
UPMLEx::update(double * const ex, int ex_x_size, int ex_y_size, int ex_z_size,
...
void
UPMLEy::update(double * const ey, int ey_x_size, int ey_y_size, int ey_z_size,
...
void
UPMLEz::update(double * const ez, int ez_x_size, int ez_y_size, int ez_z_size,
	       const double * const hy, int hy_x_size, int hy_y_size, int hy_z_size,
	       const double * const hx, int hx_x_size, int hx_y_size, int hx_z_size,
...
UPMLMagnetic::UPMLMagnetic(const int * const idx, int size, double muR, 
			   double c1_in, double c2_in, double c3_in, 
			   double c4_in, double c5_in, double c6_in)
    : PointwiseMaterial(idx, size), 
...
void 
UPMLMagnetic::set_mu(double mu_r)
{
    mu = mu_r * mu0;
}

void
UPMLHx::update(double * const hx, int hx_x_size, int hx_y_size, int hx_z_size,
...
void
UPMLHy::update(double * const hy, int hy_x_size, int hy_y_size, int hy_z_size,
...
void
UPMLHz::update(double * const hz, int hz_x_size, int hz_y_size, int hz_z_size,
	       const double * const ey, int ey_x_size, int ey_y_size, int ey_z_size,
	       const double * const ex, int ex_x_size, int ex_y_size, int ex_z_size,
	       double dt, double dx, double dy)
{
