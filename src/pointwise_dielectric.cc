...
void DielectricEx::update(double * const ex, int ex_x_size, int ex_y_size,
...
void DielectricEy::update(double * const ey, int ey_x_size, int ey_y_size,
...
void DielectricEz::update(double * const ez, int ez_x_size, int ez_y_size,
...
void DielectricHx::update(double * const hx, int hx_x_size, int hx_y_size,
...
void DielectricHy::update(double * const hy, int hy_x_size, int hy_y_size,
...
void DielectricHz::update(double * const hz, int hz_x_size, int hz_y_size,
